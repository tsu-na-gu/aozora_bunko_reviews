...
class Container(metaclass=ABCMeta):
    ...
    def is_modal(self) -> bool:
        ...
        not taken into user_account if a user control in this container is focused.
        """
        return False
...
class Window(Container):
    ...
    def _scroll_when_linewrapping(
        ...
        # the scroll offsets into user_account for this.)
        ...
        # Current line doesn't consume the whole height. Take scroll offsets into user_account.
    ...
    def _scroll_without_linewrapping(
        ...
        # When a preferred scroll is given, take that first into user_account.
