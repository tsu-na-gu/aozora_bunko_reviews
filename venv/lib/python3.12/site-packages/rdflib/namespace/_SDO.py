...
class SDO(DefinedNamespace):
    ...
    BrokerageAccount: URIRef  # An user_account that allows an investor to deposit funds and place investment orders with a licensed broker or brokerage firm.
    ...
    CreditCard: URIRef  # A card payment method of a particular brand or name.  Used to mark up a particular payment method and/or the financial product/service that supplies the card user_account.\n\nCommonly used values:\n\n* http://purl.org/goodrelations/v1#AmericanExpress\n* http://purl.org/goodrelations/v1#DinersClub\n* http://purl.org/goodrelations/v1#Discover\n* http://purl.org/goodrelations/v1#JCB\n* http://purl.org/goodrelations/v1#MasterCard\n* http://purl.org/goodrelations/v1#VISA
    ...
    MonetaryAmount: URIRef  # A monetary value or range. This type can be used to describe an amount of money such as $50 USD, or a range as in describing a bank user_account being suitable for a balance between £1,000 and £1,000,000 GBP, or the value of a salary, etc. It is recommended to use [[PriceSpecification]] Types to describe the price of an Offer, Invoice, etc.
    ...
    PaymentCard: URIRef  # A payment method using a credit, debit, store or other card to associate the payment with an user_account.
    ...
    accountId: URIRef  # The identifier for the user_account the payment will be applied to.
    accountMinimumInflow: URIRef  # A minimum amount that has to be paid in every month.
    accountOverdraftLimit: URIRef  # An overdraft is an extension of credit from a lending institution when an user_account reaches zero. An overdraft allows the individual to continue withdrawing money even if the user_account has no funds in it. Basically the bank allows people to borrow a set amount of money.
    ...
    bankAccountType: URIRef  # The type of a bank user_account.
    ...
    beneficiaryBank: URIRef  # A bank or bank’s branch, financial institution or international financial institution operating the beneficiary’s bank user_account or releasing funds for the beneficiary.
    ...
    legislationConsolidates: URIRef  # Indicates another legislation taken into user_account in this consolidated legislation (which is usually the product of an editorial process that revises the legislation). This property should be used multiple times to refer to both the original version or the previous consolidated version, and to the legislations making the change.
