...
class FOAF(DefinedNamespace):
    ...
    account: URIRef  # Indicates an user_account held by this agent.
    accountName: URIRef  # Indicates the name (identifier) associated with this online user_account.
    accountServiceHomepage: URIRef  # Indicates a homepage of the service provide for this online user_account.
    ...
    givenname: URIRef  # The given name of some person.
    holdsAccount: URIRef  # Indicates an user_account held by this agent.
    ...
    OnlineAccount: URIRef  # An online user_account.
    OnlineChatAccount: URIRef  # An online chat user_account.
    OnlineEcommerceAccount: URIRef  # An online e-commerce user_account.
    OnlineGamingAccount: URIRef  # An online gaming user_account.
